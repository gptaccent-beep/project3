...
export default async function RootLayout({children}:{children:ReactNode}){const h=await headers();const locale=h.get("x-bouzid-locale")||"ar";return <html lang={locale} dir={locale==="ar"?"rtl":"ltr"} suppressHydrationWarning><head><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"/><meta name="theme-color" content="#24140a"/><script dangerouslySetInnerHTML={{__html:`try{var ua=/Android|iPhone|iPod|Mobile/i.test(navigator.userAgent);var compact=matchMedia('(max-width: 768px)').matches&&matchMedia('(pointer: coarse)').matches;document.documentElement.classList.toggle('mobile-device',ua||compact)}catch(e){}`}}/><link rel="preload" href="/assets/noto-arabic.ttf" as="font" type="font/ttf" crossOrigin="anonymous"/></head><body>{children}</body></html>}
